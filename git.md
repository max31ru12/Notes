...
## Переменовать ветку локально и удаленно
...
- **ORIG_HEAD** - эта сслыка указывает на предыдущий коммит, на котором мы находились, когда применили последние изменения
